...
| P1 | CoreTax exports could proceed without mapping NPWP/DPP/PPN/faktur date columns, leading to incomplete submissions. | CoreTax settings only checked direction and non-empty mappings; export routine accepted any columns.【F:imogi_finance/imogi_finance/doctype/coretax_export_settings/coretax_export_settings.py†L7-L15】【F:imogi_finance/tax_operations.py†L330-L371】 | Validate CoreTax settings and export generation for mandatory mappings (PPN, DPP, NPWP, tax invoice date) and direction alignment before files are produced.【F:imogi_finance/imogi_finance/doctype/coretax_export_settings/coretax_export_settings.py†L7-L22】【F:imogi_finance/tax_operations.py†L195-L270】【F:imogi_finance/tax_operations.py†L343-L370】 |
| P2 | Tax Profiles could be saved without PPN Input/Output, PB1, or PPh payable accounts, risking misposted registers/closings. | Validation only checked duplicate accounts, not presence of core ledgers.【F:imogi_finance/imogi_finance/doctype/tax_profile/tax_profile.py†L10-L52】 | Enforce required PPN Input/Output, PB1 payable, and at least one PPh payable entry when saving Tax Profile.【F:imogi_finance/imogi_finance/doctype/tax_profile/tax_profile.py†L28-L61】 |
...
- CoreTax exports require PPN/DPP/NPWP/faktur date mappings and direction alignment in both settings validation and generation paths.【F:imogi_finance/imogi_finance/doctype/coretax_export_settings/coretax_export_settings.py†L7-L22】【F:imogi_finance/tax_operations.py†L195-L270】【F:imogi_finance/tax_operations.py†L343-L370】
- Tax Profiles now demand core VAT/PB1/PPh accounts before save to support registers, closings, and payments.【F:imogi_finance/imogi_finance/doctype/tax_profile/tax_profile.py†L28-L61】
- Post-migrate patch reloads CoreTax doctypes and tax reports to align schemas with new validations.【F:imogi_finance/patches/post_model_sync/ensure_coretax_export_settings.py†L1-L21】
